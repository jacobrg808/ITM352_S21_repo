...
var products = [ 
    {   
        ...
        "price" : 4.95,
        "desc" : "Torterra is a Grass-type Level-Up Pokémon LV.X card. It was first released as part of the Diamond & Pearl expansion. A purchase will net you 1x Toterra LV.X card.",
        "quantity" : 0
    },
    {
        "brand" : "Arceus LV.X",
    ...
    {
        "brand" : "Trainer's Toolkit",
        "image" : "./images/toolkit.jpg",
        "price" : 29.95,
        "desc" : "Comes with 4 booster packs, 2x Dedenne GX, 65 card sleeves, 1x tournament-legal coin, a set of damage counters, a set of die, a pack of 100 energy cards, and a box that you can store pokemon cards in.",
        "quantity" : 0
    },
    {
    ...
    {
        "brand" : "Sky Legends Booster Box Japanese",
        "image" : "./images/sky_legends_box_j.jpg",
        "price" : 49.95,
        "desc" : "Contains 30 booster packs of the Japan-only Sky Legends expansion to the Pokemon TCG. All cards are in Japanese.",
        "quantity" : 0
    },
    {
